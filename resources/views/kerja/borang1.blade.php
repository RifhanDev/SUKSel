...
@section('content')
    ...
    <div class="section-header">BORANG 1 - ANALISA KESEMPURNAAN TENDER</div>
                    ...
                    <tr class="table-row">
                        ...
                        <td class="text-center">
                            <button class="btn btn-success" data-bs-toggle="modal"
                                data-bs-target="#modalPapar">Semak</button>
                        </td>
                    </tr>
                </tbody>
            </table>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <h6 class="section-header">SENARAI SYARIKAT</h6>
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <select name="" id="" class="form-control">
                                                <option value="">Sempurna / Tidak</option>
