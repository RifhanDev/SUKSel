            ...
            <div class="card">
                <div class="card-body">
                    <div class="row mt-4 justify-content-center">
                        <div class="col-12">
                            <h4 class="card-title card-title-grey">PENGESAHAN KEHADIRAN LAWATAN TAPAK</h4>
                        </div>
                    </div>
                    <div class="row my-2">
                        <div class="col-12">
                            <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100" 
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">ROC Syarikat</th>
                                        <th class="text-center">Hadir</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td class="text-center">980405089035</td>
                                        <td class="text-center">ALI BIN ABU</td>
                                    ...
                                    <tr>
                                        <td class="text-center">940306089037</td>
                                        <td class="text-center">SULAIMAN BIN HALIM</td>
                                        <td class="text-center"></td>
                                        <td class="text-center">
                                            <input type="checkbox" name="" id="" class="form-check-input">
                                        </td>
