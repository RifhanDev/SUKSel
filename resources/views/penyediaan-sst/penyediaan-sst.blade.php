...
@section('content')
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <button class="btn btn-success" data-bs-toggle="modal"
                                                data-bs-target="#sediaSuratSetujuTerima">Sedia Surat Setuju Terima</button>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
    ...
    <!-- Modal with Tabs -->
    <div class="modal fade" id="sediaSuratSetujuTerima" tabindex="-1" aria-labelledby="sediaSuratSetujuTerimaLabel"
        aria-hidden="true">
                ...
                <div class="modal-body">
                    ...
                    <ul class="nav nav-pills custom-tab-size mb-3" role="tablist">
                        <li class="nav-item waves-effect waves-light">
                            <a class="nav-link active" data-bs-toggle="tab" href="#perincian-pembekal" role="tab"
                                aria-selected="true">
                                Perincian Pembekal
                            </a>
                        </li>
                        <li class="nav-item waves-effect waves-light">
                            <a class="nav-link" data-bs-toggle="tab" href="#surat-setuju-terima" role="tab"
                                aria-selected="false">
                                Surat Setuju Terima
                            </a>
                        </li>
                        <li class="nav-item waves-effect waves-light">
                            <a class="nav-link" data-bs-toggle="tab" href="#bon-pelaksanaan" role="tab"
                                aria-selected="false">
                                Bon Pelaksanaan
                            </a>
                        </li>
                    ...
                    <div class="tab-content">
                        <!-- Tab 1 -->
                        <div class="tab-pane fade show active" id="perincian-pembekal" role="tabpanel">
                            <div class="container-fluid">
                                <!-- Sample row from your content -->
                                <div class="row mt-4">
                                    <div class="col-12">
                                        <h4 class="card-title card-title-grey">SENARAI CADANGAN PEMBEKAL</h4>
                                    </div>
                                ...
                                <div class="row my-2">
                                    ...
                                    <div class="col-md-3">
                                        <input type="text" value="OPHL HOLDING SDN BHD" class="form-control">
                                    </div>
                                </div>

                                <div class="row my-2">
                                    <div class="col-md-3 d-flex justify-content-end">
                                        <label for="">No. MOF</label>
                                    </div>
                                    <div class="col-md-3">
                                        <input type="text" value="357-02070106" class="form-control">
                                    </div>
                                </div>
                                <div class="row my-2">
                                    <div class="col-md-3 d-flex justify-content-end">
                                ...
                                <div class="row my-2">
                                    ...
                                    <div class="col-md-3">
                                        <textarea name="" rows="4"
                                            class="form-control">TAMAN KAJANG SENTRAL, SELANGOR<br>DARUL EHSAN, ULU LANGAT,<br>SELANGOR</textarea>
                                    </div>
                                    <div class="col-6">
                                        <div class="row">
                                ...
                                <div class="row my-2">
                                    ...
                                    <div class="col-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" value="trainingserver@mail.com" name=""
                                                    class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row my-2">
                                    ...
                                    <div class="col-2"><input type="text" name="" value="QT21000000000023741"
                                            class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="row my-2">
                                    ...
                                    <div class="col-2">
                                        <textarea name=""
                                            class="form-control">TENDER PERKHIDMATAN PENILAIAN FORENSIK KEATAS SISTEM XXXX</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row my-2">
                                    ...
                                    <div class="col-3">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="insuransJaminan"
                                                id="insuransJaminan1" checked>
                                    ...
                                    <div class="col-2">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="bonPelaksanaan"
                                                id="bonPelaksanaan1" checked>
                                ...
                                <div class="row my-2">
                                    <div class="col-md-3 d-flex justify-content-end">
                                        <label for="" class="">Perlu Semakan Atas Talian</label>
                                    </div>
                                    <div class="col-3">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="semakan" id="semakan1"
                                                checked>
                                            <label class="form-check-label" for="semakan1">
                                                Ya
                                            </label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="semakan" id="semakan2">
                                            <label class="form-check-label" for="semakan2">
                                                Tidak
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-md-4 d-flex justify-content-end">
                                        <label for="" class="">Program Skim Latihan 1Malaysia(SLIM) <span
                                                class="text-danger">*</span></label>
                                    </div>
                                    <div class="col-2">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="skim" id="skim1" checked>
                                            <label class="form-check-label" for="skim">
                                                Ya
                                            </label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="skim" id="skim2">
                                            <label class="form-check-label" for="skim2">
                                                Tidak
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="row my-2">
                                    ...
                                    <div class="col-3">
                                        <textarea name="" class="form-control"
                                            rows="4">BAHAGIAN PENTADBIRAN CAWANGAN KEWANGAN KEMENTERIAN KWANGAN</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row my-2">
                                    <div class="col-3 text-end">Perjanjian Diperlukan <span class="text-danger">*</span>
                                    </div>
                                    <div class="col-3">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="insuransJaminan"
                        ...
                        <!-- Tab 2 -->
                        <div class="tab-pane fade" id="surat-setuju-terima" role="tabpanel">
                            <div class="container-fluid">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="col-12">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-4">
                                                <label class="form-label">Tarikh SST Ditandatangani Oleh Kerajaan <span
                                                        class="text-danger">*</span></label>
                                            </div>
                                            <div class="col-md-4">
                                                <input type="date" class="form-control" value="2021-10-25">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <div class="col-md-4">
                                                <label class="form-label">Penandatangan Surat Setuju Terima <span
                                                        class="text-danger">*</span></label>
                                            </div>
                                            <div class="col-md-4">
                                                <input type="text" class="form-control"
                                                    value="Penandatangan SST/Kontrak Ptj 248">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <div class="col-md-4">
                                                <label class="form-label">Jawatan Penandatangan Surat Setuju Terima <span
                                                        class="text-danger">*</span></label>
                                            </div>
                                            <div class="col-md-4">
                                                <input type="text" class="form-control"
                                        ...
                                        <table id="datatable-buttons"
                                            class="table table-bordered dt-responsive nowrap w-100" data-table-sort="id"
                                            data-table-order="asc" data-page="1">
                                            <thead>
                                                <tr>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="">Surat Setuju Terima (Termasuk Lampiran A)</td>
                                                    <td class="text-center">
                                                        <a href="#" class="d-block text-decoration-none">Muat Turun</a>
                                                        <a href="#" class="d-block text-decoration-none">Surat Setuju Terima
                                                            Kajian Forensik.pdf</a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Perakuan Penerimaan Surat Setuju Terima</td>
                                                    <td class="text-center">
                                                        <a href="#" class="text-decoration-none">Muat Turun</a>
                                                    </td>
                                                </tr>
                                                <tr>
                        ...
                        <!-- Tab 3 -->
                        <div class="tab-pane fade" id="bon-pelaksanaan" role="tabpanel">
                            <p class="text-muted">[Bon Pelaksanaan content goes here]</p>
                        </div>
                    </div>
