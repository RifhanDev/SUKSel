...
@section('content')
                    ...
                    <div class="row">
                            <div id="custom-progress-bar" class="progress-nav mb-4 p-2">
                                ...
                                <ul class="nav nav-pills progress-bar-tab custom-nav" role="tablist">
                                    <li class="nav-item" role="peringkat-pematuhan-teknikal">
                                        <button type="button" id="makluman-umum-tab" class="nav-link rounded-pill active"  data-progressbar="custom-progress-bar" data-bs-toggle="pill" data-bs-target="#makluman-umum" data-title="@lang('translation.application-information')" role="tab" aria-controls="makluman-umum" aria-selected="true">1</button>
                                    </li>
                                    <li class="nav-item" role="peringkat-pematuhan-kewangan">
                                        <button type="button" id="kod-bidang-tab" class="nav-link rounded-pill"  data-progressbar="custom-progress-bar" data-bs-toggle="pill" data-bs-target="#kod-bidang" data-title="@lang('translation.program-information')" role="tab" aria-controls="kod-bidang" aria-selected="false">2</button>
                                    </li>
                                    <li class="nav-item" role="rumusan">
                                        <button type="button" id="rumusan-tab" class="nav-link rounded-pill"  data-progressbar="custom-progress-bar" data-bs-toggle="pill" data-bs-target="#rumusan" data-title="@lang('translation.program-information')" role="tab" aria-controls="kod-bidang" aria-selected="false">3</button>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modalSemakanKetepatanDokumenTeknikal">Semak</button>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td class="">Senarai Kakitangan Teknikal dan Carta Organisasi Pasukan Projek</td>
                                                <td class="">Petender Muat Naik</td>
                                                <td class="">Menunggu Penyerahan</td>
                                                <td class="text-center">
                                                    <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modalSemakanKetepatanDokumenTeknikal">Semak</button>
                                    ...
                                    <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100" 
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-center">Menunggu Penyerahan</td>
                                                <td class="text-center">
                                                    <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modalSemakanKetepatanDokumenKewangan">Semak</button>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="">Penyata Bank Terkini (3 Bulan Terakhir) Syarikat</td>
                                                <td class="">Borang Atas Talian</td>
                                                <td class="text-center">Menunggu Penyerahan</td>
                                                <td class="text-center">
                                                    <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modalSemakanKetepatanDokumenKewangan">Semak</button>
                                            ...
                                            <tr>
                                                <td class="">Salinan Sijil Pendaftaran dengan Kementerian Kewangan</td>
                                                <td class="">Petender Muat Naik</td>
                                                <td class="text-center">Menunggu Penyerahan</td>
                                                <td class="text-center">
                                                    <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modalSemakanKetepatanDokumenKewangan">Semak</button>
                                            ...
                                            <tr>
                                                <td class="">Surat Akuan Pembida</td>
                                                <td class="">PTJ Muat Naik</td>
                                                <td class="text-center">Menunggu Penyerahan</td>
                                                <td class="text-center"><button class="btn btn-success">Semak</button></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
    ...
    <div class="modal fade" id="modalSemakanKetepatanDokumenTeknikal" tabindex="-1" aria-labelledby="modalSemakanKetepatanDokumenTeknikalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-body">
                    <h4 class="card-title card-title-grey">SEMAKAN KETEPATAN DOKUMENT TEKNIKAL</h4>
                    <div class="row mb-4">
                        <div class="col-12">
    ...
    <div class="modal fade" id="modalSemakanKetepatanDokumenKewangan" tabindex="-1" aria-labelledby="modalSemakanKetepatanDokumenKewanganLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-body">
