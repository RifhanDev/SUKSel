            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="tab-content" id="application-content">
                        <div class="tab-pane fade show active" id="agency" role="tabpanel" aria-labelledby="makluman-umum-tab">
                                        ...
                                        <!-- Jenis Sebut Harga / Tender -->
                                            <div class="col-md-6 my-2">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="radio" name="jenisSebutHargaTender" id="jenisSebutHargaTender1" checked>
                                        ...
                                        <!-- Kaedah Penilaian -->
                                            <div class="col-md-6 my-2">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="radio" name="kaedahPenilaian" id="kaedahPenilaian1">
                                                            <label class="form-check-label" for="kaedahPenilaian1">
                                                                1 Peringkat
                                                            </label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="radio" name="kaedahPenilaian" id="kaedahPenilaian2" checked>
                                        ...
                                        <!-- Kelulusan Spesifikasi Daripada Kementerian -->
                                            <div class="col-md-6 my-2">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="radio" name="kelulusanSpesifikasiDaripadaKementerian" id="kelulusanSpesifikasiDaripadaKementerian1">
                                                            <label class="form-check-label" for="kelulusanSpesifikasiDaripadaKementerian1">
                                                                Ya
                                                            </label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="radio" name="kelulusanSpesifikasiDaripadaKementerian" id="kelulusanSpesifikasiDaripadaKementerian2" checked>
                            ...
                            <div class="row">
                                <div class="col-12 d-flex justify-content-between">
                                    ...
                                    <div class="right">
                                        ...
                                        <button type="button" class="btn btn-primary ms-auto" data-step="step1" data-currenttab="application-content" data-nexttab="kod-bidang-tab">
                                            Seterusnya
                                        </button>
                                    </div>
                                </div>
                        ...
                        <div class="tab-pane fade" id="kod-bidang" role="tabpanel" aria-labelledby="kod-bidang-tab">
                            <div class="row mt-4 justify-content-center">
                                <div class="col-12">
                                    ...
                                    <p class="card-title-desc text-primary fst-italic">
                                        Syarikat Selangor Sahaja atau Syarikat Selangor dan Lain-lain Negeri <span class="text-danger">wajib</span> di isi.
                                    </p>
                                </div>
                            </div>
                            <div class="row d-flex justify-content-center">
