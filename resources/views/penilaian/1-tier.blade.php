            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div id="custom-progress-bar" class="progress-nav mb-4 p-2">
                            ...
                            <ul class="nav nav-pills progress-bar-tab custom-nav" role="tablist">
                                <li class="nav-item" role="pematuhan-dokumentasi-teknikal">
                                    <button type="button" id="dokumentasi1-tab" class="nav-link rounded-pill active"
                                        data-progressbar="custom-progress-bar" data-bs-toggle="pill"
                                        data-bs-target="#dokumentasi1"
                                        data-title="@lang('translation.application-information')" role="tab"
                                        aria-controls="dokumentasi1" aria-selected="true">1</button>
                                </li>
                                <li class="nav-item" role="pematuhan-spesifikasi-teknikal">
                                    <button type="button" id="spesifikasi1-tab" class="nav-link rounded-pill"
                                        data-progressbar="custom-progress-bar" data-bs-toggle="pill"
                                        data-bs-target="#spesifikasi1" data-title="@lang('translation.program-information')"
                                        role="tab" aria-controls="spesifikasi1" aria-selected="false">2</button>
                                </li>
                                <li class="nav-item" role="pematuhan-dokumentasi-kewangan">
                                    <button type="button" id="dokumentasi2-tab" class="nav-link rounded-pill"
                                        data-progressbar="custom-progress-bar" data-bs-toggle="pill"
                                        data-bs-target="#dokumentasi2" data-title="@lang('translation.program-information')"
                                        role="tab" aria-controls="dokumentasi2" aria-selected="false">3</button>
                                </li>
                                <li class="nav-item" role="penyata-bulanan-bank">
                                    <button type="button" id="penyata-tab" class="nav-link rounded-pill"
                                        ...
                                        role="tab" aria-controls="penyata" aria-selected="false">4</button>
                                </li>
                                <li class="nav-item" role="pematuhan-spesifikasi-kewangan">
                                    <button type="button" id="spesifikasi2-tab" class="nav-link rounded-pill"
                                        data-progressbar="custom-progress-bar" data-bs-toggle="pill"
                                        data-bs-target="#spesifikasi2" data-title="@lang('translation.program-information')"
                                        role="tab" aria-controls="spesifikasi2" aria-selected="false">5</button>
                                </li>
                                <li class="nav-item" role="penyediaan-laporan">
                                    <button type="button" id="laporan-tab" class="nav-link rounded-pill"
                                        ...
                                        role="tab" aria-controls="laporan" aria-selected="false">6</button>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="tab-content px-3" id="application-content">
                        ...
                        <!-- Outer Tab 1 Content -->
                        <div class="tab-pane fade show active" id="dokumentasi1" role="tabpanel"
                            aria-labelledby="dokumentasi1-tab">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <button class="btn btn-success" data-bs-toggle="modal"
                                                        data-bs-target="#modalPematuhanDokumenTeknikal">Menilai</button>
                                                </td>
                                            </tr>
                                            <tr>
                        ...
                        <!-- Outer Tab 2 Content -->
                        <div class="tab-pane fade" id="spesifikasi1" role="tabpanel" aria-labelledby="spesifikasi1-tab">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade show active" id="teknikal-2" role="tabpanel">
                                    ...
                                    <p class="card-title-desc text-primary fst-italic">Klik butang Semak untuk
                                        meneruskan
                                        penilaian</p>
                                    <table class="table table-bordered dt-responsive nowrap w-100">
                                        <thead>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <button class="btn btn-success" data-bs-toggle="modal"
                                                        data-bs-target="#modalPenilaianSpesifikasiTeknikal">Menilai</button>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="">Surat Pengesahan Prinsipal yang lengkap ditandatangani</td>
                                            ...
                                            <tr>
                                                <td class="">Senarai Kakitangan Teknikal dan Carta Organisasi Pasukan
                                                    Projek
                                                </td>
                                                <td class="">Petender Muat Naik</td>
                                                <td class="">Selesai</td>
                                ...
                                <div class="tab-pane fade" id="rumusan-2" role="tabpanel" aria-labelledby="rumusan-tab">
                                    <div class="container-fluid mt-3">
                                        <!-- SECTION 1: Pembekal Melepasi -->
                                        <div class="row">
                                            <div class="col-12 bg-light p-2 fw-bold">
                        ...
                        <!-- Outer Tab 3 Content -->
                        <div class="tab-pane fade" id="dokumentasi2" role="tabpanel" aria-label="dokumentasi1-tab">

                            {{-- Inner tabs for outer tab 3 --}}
                            <ul class="nav nav-pills custom-tab-size mb-3" role="tablist">
                                <li class="nav-item waves-effect waves-light">
                                    <a class="nav-link active" data-bs-toggle="tab" href="#teknikal-3" role="tab"
                                        aria-selected="true">Kewangan</a>
                                </li>
                                <li class="nav-item waves-effect waves-light">
                            ...
                            <div class="tab-content">
                                    ...
                                    <table class="table table-bordered dt-responsive nowrap w-100">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <button class="btn btn-success" data-bs-toggle="modal"
                                                        data-bs-target="#modalPematuhanDokumenKewangan">Papar</button>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="">Maklumat Profil Petender</td>
                                                <td class="">Borang Atas Talian</td>
                                                <td class="">Selesai</td>
                                                <td class="text-center">
                                                    <button class="btn btn-success">Papar</button>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="">Penyata Bank Terkini (3 Bulan Terakhir) Syarikat
                                                </td>
                                                <td class="">Borang Atas Talian</td>
                                                <td class="">Selesai</td>
                                                <td class="text-center">
                                            ...
                                            <tr>
                                                <td class="">salinan Sijil Pendaftaran dengan Kementerian Kewangan
                                                </td>
                                                <td class="">Petender Muat Naik</td>
                                                <td class="">Selesai</td>
                                                <td class="text-center">
                                            ...
                                            <tr>
                                                <td class="">Surat Akuan Pembida
                                                </td>
                                                <td class="">PTJ Muat Naik</td>
                                                <td class="">Selesai</td>
                                                <td class="text-center">
                                                    <button class="btn btn-success">Papar</button>
                                                </td>
                                ...
                                <div class="tab-pane fade" id="rumusan-3" role="tabpanel" aria-labelledby="rumusan-tab">
                                    <div class="container-fluid mt-3">
                                        <!-- SECTION 1: Pembekal Melepasi -->
                                        <div class="row">
                                            <div class="col-12 bg-light p-2 fw-bold">
                        ...
                        <!-- Outer Tab 4 Content -->
                        <div class="tab-pane fade" id="penyata" role="tabpanel" aria-label="penyata-tab">

                            <!-- Outer Tab 4 Content -->
                            <ul class="nav nav-pills custom-tab-size mb-3" role="tablist">
                                <li class="nav-item waves-effect waves-light">
                                    <a class="nav-link active" data-bs-toggle="tab" href="#teknikal-4" role="tab"
                                        aria-selected="true">Kewangan</a>
                                </li>
                                <li class="nav-item waves-effect waves-light">
                                    <a class="nav-link" data-bs-toggle="tab" href="#rumusan-4" role="tab"
                                        aria-selected="false">Rumusan</a>
                                </li>
                            </ul>
                            <div class="tab-content">

                                <div class="tab-pane fade show active" id="teknikal-4" role="tabpanel">
                                    <h4 class="card-title card-title-grey">PENYATA BULANAN BANK</h4>
                                    <p class="card-title-desc text-primary fst-italic">Klink Butang Menilai untuk meneruskan
                                        penilaian</p>
                                    <table class="table table-bordered dt-responsive nowrap w-100">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-center"><button class="btn btn-success"
                                                        ...
                                                        data-bs-target="#modalPenilaianCadanganKewangan">Papar</button>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                        ...
                        <!-- Outer Tab 5 Content -->
                        <div class="tab-pane fade" id="spesifikasi2" role="tabpanel" aria-label="spesifikasi2-tab">
                            {{-- Inner tabs for outer tab 5 --}}
                            <ul class="nav nav-pills custom-tab-size mb-3" role="tablist">
                                <li class="nav-item waves-effect waves-light">
                                    <a class="nav-link active" data-bs-toggle="tab" href="#teknikal-5" role="tab"
                                        aria-selected="true">Kewangan</a>
                                </li>
                                <li class="nav-item waves-effect waves-light">
                                    <a class="nav-link" data-bs-toggle="tab" href="#rumusan-5" role="tab"
                                        aria-selected="false">Rumusan</a>
                                </li>
                            </ul>
                            <div class="tab-content">

                                <div class="tab-pane fade show active" id="teknikal-5" role="tabpanel">

                                    <!-- Content for Teknikal of progress 5 -->
                                    ...
                                    <table class="table table-bordered dt-responsive nowrap w-100">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <button class="btn btn-success" data-bs-toggle="modal"
                                                        data-bs-target="#modalCadanganKewangan">Papar</button>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="">Maklumat Profil Petender</td>
                                ...
                                <div class="tab-pane fade" id="rumusan-5" role="tabpanel" aria-labelledby="rumusan-tab">
                                    <div class="container-fluid mt-3">
                                        <!-- SECTION 1: Pembekal Melepasi -->
                                        <div class="row">
                                            <div class="col-12 bg-light p-2 fw-bold">
                        ...
                        <div class="tab-pane fade" id="laporan" role="tabpanel" aria-labelledby="laporan-tab">
                            ...
                            <div class="mb-3 mt-2">
                                <div class="card-title card-title-grey">SENARAI PEMBEKAL YANG MELEPASI PENILAIAN SPESIFIKASI TEKNIKAL
                                </div>
                                <table class="table table-bordered text-center align-middle mt-2">
                                    <thead class="table-primary text-white">
                                        <tr>
                            ...
                            <div class="mb-3">
                                <div class="card-title card-title-grey">SENARAI PEMBEKAL YANG TIDAK MELEPASI SPESIFIKASI TEKNIKAL
                                </div>
                                <table class="table table-bordered text-center align-middle mt-2">
                                    <thead class="table-primary text-white">
                                        <tr>
                            ...
                            <div class="mb-3 mt-2">
                                <div class="card-title card-title-grey">SENARAI PEMBEKAL YANG MELEPASI PENILAIAN PEMATUHAN DOKUMENTASI
                                </div>
                                <table class="table table-bordered text-center align-middle mt-2">
                                    <thead class="table-primary text-white">
                                        <tr>
                            ...
                            <div class="mb-3">
                                <div class="card-title card-title-grey">SENARAI PEMBEKAL TIDAK MELEPASI PEMATUHAN DOKUMENTASI</div>
                                <table class="table table-bordered text-center align-middle mt-2">
                                    <thead class="table-primary text-white">
                                        <tr>
                                            <th>BIL</th>
                            ...
                            <!-- Penilaian Peringkat Keempat -->
                            <h5 class="fw-bold mt-4">PENILAIAN PERINGKAT KEEMPAt:</h5>

                            <div class="mb-3 mt-2">
                                <div class="card-title card-title-grey">SENARAI PEMBEKAL YANG MELEPASI PENILAIAN PENILAIAN PENYATA BULANAN BANK
                                </div>
                                <table class="table table-bordered text-center align-middle mt-2">
                                    <thead class="table-primary text-white">
                                        <tr>
                            ...
                            <div class="mb-3">
                                <div class="card-title card-title-grey">SENARAI PEMBEKAL YANG TIDAK MELEPASI PENILAIAN PENILAIAN PENYATA BULANAN BANK</div>
                                <table class="table table-bordered text-center align-middle mt-2">
                                    <thead class="table-primary text-white">
                                        <tr>
                                            <th>BIL</th>
                            ...
                            <!-- Penilaian Peringkat Kelima -->
                            <h5 class="fw-bold mt-4">PENILAIAN PERINGKAT KELIMA:</h5>

                            <div class="mb-3 mt-2">
                                <div class="card-title card-title-grey">SENARAI PEMBEKAL YANG MELEPASI PENILAIAN PENILAIAN KEWANGAN
                                </div>
                                <table class="table table-bordered text-center align-middle mt-2">
                                    <thead class="table-primary text-white">
                                        <tr>
                            ...
                            <div class="mb-3">
                                <div class="card-title card-title-grey">SENARAI PEMBEKAL YANG TIDAK MELEPASI PENILAIAN PENILAIAN KEWANGAN</div>
                                <table class="table table-bordered text-center align-middle mt-2">
                                    <thead class="table-primary text-white">
                                        <tr>
                                            <th>BIL</th>
                    ...
                    <!-- MODAL -->
                    <div class="modal fade" id="modalPematuhanDokumenTeknikal" tabindex="-1" aria-labelledby="modalLabel"
                        aria-hidden="true">
                    ...
                    <div class="modal fade" id="modalPenilaianSpesifikasiTeknikal" tabindex="-1"
                        aria-labelledby="modalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-xl">
                            <div class="modal-content">
                                <div class="modal-header bg-light">
                                    <h5 class="modal-title" id="modalLabel">PENILAIAN SPESIFIKASI TEKNIKAL
                                    </h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                                </div>
                                ...
                                <div class="modal-body">
                                    <p><strong>Tajuk/Dokumen:</strong> Perkhidmatan Penilaian Forensik Keatas Sistem XXXX
                                    </p>
                                    <!-- Title / Document -->
                                    <div class="mb-3">
                                        <h4 class="card-title card-title-grey">SENARAI PEMBEKAL</h4>
                                        ...
                                        <table class="table table-bordered align-middle">
                                            <thead class="table-primary text-center">
                                                <tr>
                                                    ...
                                                    <th style="width: 22%;">Skor Automatik</th>
                                                    <th style="width: 22%;">Skor Manual</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <button class="btn btn-success"
                                                            id="openSenaraiTeknikal">Menilai</button>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="text-center">2/2</td>
                                                    ...
                                                    <td class="text-center">6</td>
                                                    <td class="text-center">
                                                        <button class="btn btn-success">Menilai</button>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                    ...
                    <div class="modal fade" id="modalSenaraiSpesifikasiTeknikal" tabindex="-1" aria-labelledby="modalLabel"
                        aria-hidden="true">
                        <div class="modal-dialog modal-xl">
                            <div class="modal-content">
                                <div class="class-header bg-light">
                                    <h5 class="modal-title" id="modallabel">SENARAI SPESIFIKASI TEKNIKAL</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                                </div>
                                ...
                                <div class="modal-body">
                                    <div class="table-responsive">
                                        <table class="table table-borded align-middle">
                                            <thead class="table-primary text-center">
                                                <tr>
                                                    <th style="width: 25%;">Item/Spesifikasi</th>
                                                    <th style="width: 5%;">Unit Ukuran</th>
                                                    <th style="width: 5%;">Kekerapan Unit Ukuran</th>
                                                    <th style="width: 5%;">Bil.Unit Ukuran Sehari</th>
                                                    <th style="width: 5%;">Bil.Unit Ukuran Sebulan</th>
                                                    <th style="width: 5%;">Kuantiti</th>
                                                    <th style="width: 10;">Maklumbalas</th>
                                                    <th style="width: 10;">Catatan Pembekal</th>
                                                    <th style="width: 5;">Skor Automatik</th>
                                                    <th style="width: 5;">Skor Manual</th>
                                                    <th style="width: 20;">Catatan</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                    ...
                                    <div class="modal-footer justify-content-center">
                                        <button type="button" class="btn btn-success"
                                            id="btnSimpanPenilaian">Kembali</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal fade" id="modalPematuhanDokumenKewangan" tabindex="-1" aria-label="modalLabel"
                        aria-hidden="true">
                        <div class="modal-dialog modal-xl">
                            <div class="modal-content">
                                <div class="class-header bg-light">
                                    <h5 class="modal-title" id="modallabel">SEMAKAN PEMATUHAN DOKUMEN KEWANGAN</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <p><strong>Tajuk/Dokumen:</strong> Perkhidmatan Penilaian Dokumen Forensik Keatas Sistem
                                        XXXX</p>
                                    <div class="mb-3">
                                        <h4 class="card-title-grey card-title-grey">SENARAI PEMBEKAL</h4>
                                    </div>
                    ...
                    <div class="modal fade" id="modalPenilaianCadanganKewangan" tabindex="-1" aria-label="modalLabel"
                        aria-hidden="true">
                        <div class="modal-dialog modal-xl">
                            <div class="modal-content">
                                <div class="modal-header bg-light">
                                ...
                                <div class="modal-body">
                                    <p><strong>Tajuk/Dokumen:</strong> Penyata Bank Terakhir (3 Bulan Terakhir) Syarikat
                                    </p>
                                    <!-- Title / Document -->
                                    <div class="mb-3">
                                        <h4 class="card-title card-title-grey">SENARAI PEMBEKAL</h4>
                                        ...
                                        <table class="table table-bordered align-middle">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-center">Selesai</td>
                                                    <td class="text-center">
                                                        <button class="btn btn-success" id="openSemakSilang">Papar</button>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="text-center">2/2</td>
                    ...
                    <div class="modal fade" id="modalDokumenSemakSilang" tabindex="-1" aria-label="modalLabel"
                        aria-hidden="true">
                        <div class="modal-dialog modal-xl">
                            <div class="modal-content">
                                <div class="modal-header bg-light">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered align-middle">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>Kunci kira-kira Tahunan (Nota untuk syarikat ROC, ini mestilah
                                                        salinan yang
                                                        telah diaudit)</td>
                                                    <td class="text-center">
                                                        <button class="btn btn-success">Papar</button>
                                                ...
                                                <tr>
                                                    <td>Pengesahan dari institusi kewangan untuk tiga bulan penyata bank
                                                    </td>
                                                    <td class="text-center">
                                                        <button class="btn btn-success">Papar</button>
                                                    </td>
                    ...
                    <div class="modal fade" id="modalCadanganKewangan" tabindex="-1" aria-label="modalLabel"
                        aria-hidden="true">
                        <div class="modal-dialog modal-xl">
                            <div class="modal-content">
                                <div class="modal-header bg-light">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row mb-3 align-items-center">
                                        <div class="col-md-3">
                                            <label class="form-label mb-0 me-2">Jumlah Harga Indikatif Sebenar (RM):</label>
                                        </div>
                                        <div class="col-md-2">
                    ...
                    <script>
                        // Reusable function to switch between modals
                        function switchModal(hideId, showId) {
                            const modalToHide = bootstrap.Modal.getInstance(document.getElementById(hideId));
                            if (modalToHide) {
                                modalToHide.hide();

                                document.getElementById(hideId).addEventListener('hidden.bs.modal', function handler() {
                                    const modalToShow = new bootstrap.Modal(document.getElementById(showId));
                                    modalToShow.show();

                                    // Clean up event listener after one use
                                    document.getElementById(hideId).removeEventListener('hidden.bs.modal', handler);
                                });
                            }
                        }

                        // Existing modal flow: modalPenilaianSpesifikasiTeknikal → modalSenaraiSpesifikasiTeknikal
                        document.getElementById('openSenaraiTeknikal').addEventListener('click', function () {
                            switchModal('modalPenilaianSpesifikasiTeknikal', 'modalSenaraiSpesifikasiTeknikal');
                        });

                        document.getElementById('btnSimpanPenilaian').addEventListener('click', function () {
                            switchModal('modalSenaraiSpesifikasiTeknikal', 'modalPenilaianSpesifikasiTeknikal');
                        });

                        // 🔄 New modal flow: modalPenilaianCadanganKewangan → modalDokumenSemakSilang
                        document.getElementById('openSemakSilang').addEventListener('click', function () {
                            switchModal('modalPenilaianCadanganKewangan', 'modalDokumenSemakSilang');
                        });

                        // Return to modalPenilaianCadanganKewangan after closing modalDokumenSemakSilang
                        document.getElementById('modalDokumenSemakSilang').addEventListener('hidden.bs.modal', function () {
                            const returnModal = new bootstrap.Modal(document.getElementById('modalPenilaianCadanganKewangan'));
                            returnModal.show();
                        });
                    </script>
