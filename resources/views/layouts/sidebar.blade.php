<style>
	...
	#sidebar-menu ul li.has-arrow:hover>a,
	#sidebar-menu ul li.active-parent:hover>a {
		opacity: 0.6;
...
@php
	...
	$grpKertasCadangan = $is(
	    'kertas-cadangan-teknikal',
	    'kertas-cadangan-kewangan',
	    'perakuan',
	    'surat-akuan-pembida',
	    'maklumat-umum',
	);
	...
	<div data-simplebar class="h-100">
		<div id="sidebar-menu">
			<ul class="metismenu list-unstyled" id="side-menu">
				...
				{{-- Top-level items --}}
				<li>
					<a href="{{ url('cipta-tender') }}" class="waves-effect {{ request()->is('cipta-tender') ? 'active' : '' }}">
				...
				<li>
					...
					<ul id="submenu-skor" class="sub-menu collapse {{ $grpSkor ? 'show' : '' }}" data-bs-parent="#side-menu">
						<li><a href="{{ route('senarai-semak-teknikal') }}" class="{{ $is('senarai-semak-teknikal') ? 'active' : '' }}"
								key="t-p-grid">@lang('translation.Senarai_Semak_Teknikal')</a></li>
						<li><a href="{{ route('senarai-semak-kewangan') }}" class="{{ $is('senarai-semak-kewangan') ? 'active' : '' }}"
						...
						<li><a href="{{ route('skor-keseluruhan') }}" class="{{ $is('skor-keseluruhan') ? 'active' : '' }}"
				...
				<li>
					<a href="{{ route('lawatan-tapak') }}" class="waves-effect {{ $is('lawatan-tapak') ? 'active' : '' }}">
				...
				<li>
					<a href="#submenu-semakan" class="has-arrow waves-effect {{ $grpSemakanDok ? 'active-parent' : '' }}"
					...
					<ul id="submenu-semakan" class="sub-menu collapse {{ $grpSemakanDok ? 'show' : '' }}" data-bs-parent="#side-menu">
						...
						<li>
							<a href="#submenu-mesyuarat"
								...
								data-bs-toggle="collapse" aria-expanded="{{ $is('perincian-mesyuarat', 'jawatankuasa') ? 'true' : 'false' }}">
							...
							<ul id="submenu-mesyuarat"
								...
								<li><a href="{{ route('perincian-mesyuarat') }}" class="{{ $is('perincian-mesyuarat') ? 'active' : '' }}"
										key="t-p-grid">@lang('translation.Perincian_Mesyuarat')</a></li>
								<li><a href="{{ route('jawatankuasa') }}" class="{{ $is('jawatankuasa') ? 'active' : '' }}"
						...
						<li>
							...
							<ul id="submenu-penilaian-kertas"
								...
								<li><a href="{{ route('peringkat-pematuhan') }}" class="{{ $is('peringkat-pematuhan') ? 'active' : '' }}"
										key="t-p-grid">@lang('translation.Peringkat_Pematuhan')</a></li>
								<li><a href="{{ route('peringkat-penilaian') }}" class="{{ $is('peringkat-penilaian') ? 'active' : '' }}"
				...
				<li>
					<a href="{{ route('penyediaan-sst') }}" class="waves-effect {{ $is('penyediaan-sst') ? 'active' : '' }}">
				...
				{{-- SECOND ROLE SECTION --}}
				<li>
					<a href="{{ route('getCiptaTender') }}" class="waves-effect {{ $is('getCiptaTender') ? 'active' : '' }}">
						<span>@lang('translation.Cipta_Tender')</span>
					</a>
				</li>

				<li>
					<a href="{{ route('getKelulusan') }}" class="waves-effect {{ $is('getKelulusan') ? 'active' : '' }}">
						<span>@lang('translation.Kelulusan_')</span>
					</a>
				</li>

				<li>
					<a href="{{ route('PenyediaanIklan') }}" class="waves-effect {{ $is('PenyediaanIklan') ? 'active' : '' }}">
				...
				<li>
					<a href="{{ route('butiran-dilihat') }}" class="waves-effect {{ $is('butiran-dilihat') ? 'active' : '' }}">
				...
				<li>
					<a href="{{ route('maklumat-ralat') }}" class="waves-effect {{ $is('maklumat-ralat') ? 'active' : '' }}">
				...
				{{-- Kertas Cadangan --}}
				<li>
					<a href="#submenu-kertas" class="has-arrow waves-effect {{ $grpKertasCadangan ? 'active-parent' : '' }}"
					...
					<ul id="submenu-kertas" class="sub-menu collapse {{ $grpKertasCadangan ? 'show' : '' }}"
						...
						<li><a href="{{ route('maklumat-umum') }}" class="{{ $is('maklumat-umum') ? 'active' : '' }}">Maklumat
								Umum</a></li>
					</ul>
				</li>
				...
				<li>
					<a href="#submenu-penilaian-tek"
						class="has-arrow waves-effect {{ $grpPeringkatPenilaianTek ? 'active-parent' : '' }}" data-bs-toggle="collapse"
						aria-expanded="{{ $grpPeringkatPenilaianTek ? 'true' : 'false' }}">
						<span>Peringkat Penilaian Teknikal</span>
					</a>
					<ul id="submenu-penilaian-tek" class="sub-menu collapse {{ $grpPeringkatPenilaianTek ? 'show' : '' }}"
						data-bs-parent="#side-menu">
				...
				{{-- Pembelian Terus --}}
				<li>
					<a href="#submenu-pbt" class="has-arrow waves-effect {{ $grpPembelianTerus ? 'active-parent' : '' }}"
					...
					<ul id="submenu-pbt" class="sub-menu collapse {{ $grpPembelianTerus ? 'show' : '' }}"
						data-bs-parent="#side-menu">
						<li><a href="{{ route('cipta-projek') }}" class="{{ $is('cipta-projek') ? 'active' : '' }}">Cipta Projek
								Pembelian Terus</a></li>
						<li><a href="{{ route('sebut-harga') }}" class="{{ $is('sebut-harga') ? 'active' : '' }}">Sebut
								Harga Pembelian Terus</a></li>
						<li><a href="{{ route('cut-off-pb') }}" class="{{ $is('cut-off-pb') ? 'active' : '' }}">Cut-Off</a></li>
				...
				<li>
					...
					<ul id="submenu-tetapan"
						...
						{{-- Pengurusan Peranan --}}
						<li>
							<a href="{{ route('pengurusan-peranan') }}" class="{{ $is('pengurusan-peranan') ? 'active' : '' }}">
						...
						{{-- Pengurusan Menu --}}
						<li>
							<a href="{{ route('pengurusan-menu') }}" class="{{ $is('pengurusan-menu') ? 'active' : '' }}">
				...
				<li>
					...
					<ul id="submenu-kerja" class="sub-menu collapse {{ $grpKerja ? 'show' : '' }}" data-bs-parent="#side-menu">
						...
						<li>
							...
							<ul id="submenu-penilaian-dok"
								...
								<li><a href="{{ route('borang1') }}" class="{{ $is('borang1') ? 'active' : '' }}">Borang 1</a></li>
								<li><a href="{{ route('borang2') }}" class="{{ $is('borang2') ? 'active' : '' }}">Borang 2</a></li>

								{{-- Borang 3 (sub of Kewangan) --}}
								<li>
									<a href="#submenu-borang3" class="has-arrow waves-effect {{ $grpBorang3 ? 'active-parent' : '' }}"
										data-bs-toggle="collapse" aria-expanded="{{ $grpBorang3 ? 'true' : 'false' }}">
										Borang 3
									</a>
									<ul id="submenu-borang3" class="sub-menu collapse {{ $grpBorang3 ? 'show' : '' }}">
										...
										<li><a href="{{ route('lembaran-imbangan') }}"
												...
												Imbangan</a></li>
										<li><a href="{{ route('akaun-bank') }}" class="{{ $is('akaun-bank') ? 'active' : '' }}">Akaun Bank</a>
										</li>
										<li><a href="{{ route('bon-saham') }}" class="{{ $is('bon-saham') ? 'active' : '' }}">Bon Atau Saham</a>
										</li>
									</ul>
								</li>

								<li><a href="{{ route('borang4') }}" class="{{ $is('borang4') ? 'active' : '' }}">Borang 4</a></li>
								<li><a href="{{ route('borang5') }}" class="{{ $is('borang5') ? 'active' : '' }}">Borang 5</a></li>
								<li><a href="{{ route('borang6') }}" class="{{ $is('borang6') ? 'active' : '' }}">Borang 6</a></li>

								{{-- Borang 7 --}}
								<li>
									<a href="#submenu-borang7" class="has-arrow waves-effect {{ $grpBorang7 ? 'active-parent' : '' }}"
										data-bs-toggle="collapse" aria-expanded="{{ $grpBorang7 ? 'true' : 'false' }}">
										Borang 7
									</a>
									<ul id="submenu-borang7" class="sub-menu collapse {{ $grpBorang7 ? 'show' : '' }}"
										data-bs-parent="#side-menu">
										<li><a href="{{ route('borang7a') }}" class="{{ $is('borang7a') ? 'active' : '' }}">Borang Serupa</a>
										</li>
										<li><a href="{{ route('borang7b') }}" class="{{ $is('borang7b') ? 'active' : '' }}">Borang Sebanding</a>
										</li>
									</ul>
								</li>

								<li><a href="{{ route('borang8') }}" class="{{ $is('borang8') ? 'active' : '' }}">Borang 8</a></li>

								{{-- Borang 9 --}}
								<li>
									<a href="#submenu-borang9" class="has-arrow waves-effect {{ $grpBorang9 ? 'active-parent' : '' }}"
										data-bs-toggle="collapse" aria-expanded="{{ $grpBorang9 ? 'true' : 'false' }}">
										Borang 9
									</a>
									<ul id="submenu-borang9" class="sub-menu collapse {{ $grpBorang9 ? 'show' : '' }}"
										data-bs-parent="#side-menu">
										<li><a href="{{ route('borang9') }}" class="{{ $is('borang9') ? 'active' : '' }}">Borang 9</a></li>
										<li><a href="{{ route('borang9a') }}" class="{{ $is('borang9a') ? 'active' : '' }}">Kerja Serupa</a>
										</li>
										<li><a href="{{ route('borang9b') }}" class="{{ $is('borang9b') ? 'active' : '' }}">Kerja Sebanding</a>
										</li>
									</ul>
								</li>

								<li><a href="{{ route('borang10') }}" class="{{ $is('borang10') ? 'active' : '' }}">Borang 10</a></li>

								<li><a href="{{ route('borang11') }}" class="{{ $is('borang11') ? 'active' : '' }}">Borang 11</a></li>

								<li><a href="{{ route('borang12') }}" class="{{ $is('borang12') ? 'active' : '' }}">Borang 12</a></li>

								<li><a href="{{ route('borang13') }}" class="{{ $is('borang13') ? 'active' : '' }}">Borang 13</a></li>

								<li><a href="{{ route('borang14') }}" class="{{ $is('borang14') ? 'active' : '' }}">Borang 14</a></li>

								<li><a href="{{ route('borang15') }}" class="{{ $is('borang15') ? 'active' : '' }}">Borang 15</a></li>
							</ul>
						</li>
